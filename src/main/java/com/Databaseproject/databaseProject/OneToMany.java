...
/**
*Represent a correlation between two tables where the records of table1
*can be linked to multiple records of table2 but
*each record of table2 can be linked only to one record of table1
*/
