...
public class ExampleDomwnDedomenwn {

	public static HashMap <String, Integer> primaryKey = new HashMap <String, Integer> ();
	public static HashMap <String, ArrayList> names = new HashMap <String, ArrayList> ();
	...
	public static void main (String [] args) {
		...
		for(String key: primaryKey.keySet())
			System.out.println(key + " - " + primaryKey.get(key));
			System.out.println();
